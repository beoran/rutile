# encoding: UTF-8
# ruby prototype for the Rutile language
...
module Rutile
  ...
  class Lexer
    ...
    # Uses a simplistic state machine
    def lex_char(ch) 
      for rule in @rules do 
        ...
        case rule[:act] 
          ...
          # when you recieve this you mustcall lex_char again with the 
          # same token so it gets processed too!
            text  = @text
            @text = ''
